AGENTS.MD: Project-Specific Agent Tasks
ATTENTION AI AGENT: This document contains the specific business logic, inputs, and outputs for each agent in this project. To successfully complete your task, you MUST also read and adhere to all project-wide standards for logging, configuration, LLM interaction, and unit testing as defined in the AGENTS.md file located in the root directory of this repository.
...
Update config/checklist.yml to set the status for agentId: 1.100.

Write a new log file to PROGRESS_LOGS/new/ summarizing the work.

Agent ID: 1.200 - Patient Population Analysis Agent
Objective: To analyze data sources to quantify the addressable patient population.
...
Update config/checklist.yml to set the status for agentId: 1.200.
